...
la cantidad de valores aleatorios a generar y otro: el umbral maximo que deben
tener los valores generados.

el valor minimo de los valores generados será 1 
...
int main(int argc, char *argv[]){
    ...
    srand(time(NULL));
    if (argc == 3){
        /*Rescata los valores de la linea de comandos */
        n = atoi(argv[1]);
        umbral = atoi(argv[2]);
        for (int i = 1 ; i<=n; i++ ){
